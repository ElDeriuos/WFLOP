PROGRAM windfarm_optimizer
    ...
    ! ------------------------------------------------------------------
    ! MODULE IMPORTS (These are our future "Workers")
    ! ------------------------------------------------------------------
    USE mod_precision, ONLY: wp           ! Standardizes working precision
    USE mod_types                         ! Contains our TYPE definitions
    USE mod_io                            ! Reading/Writing files
    USE mod_physics                       ! Wake models and AEP
    USE mod_NSGA_II                       ! GA / NSGA-II mechanisms

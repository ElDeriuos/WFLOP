...
class WindFarmGUI:
    def __init__(self, root):
        ...
        self.root.title("Hadi Dadash")
        self.root.geometry("680x800") # Made slightly wider to fit the scrollbar gracefully
        ...
        self.viz_level_idx = tk.StringVar(value="1") # ADD THIS LINE
    ...
    def build_scrollable_container(self):
        """Creates a Canvas and Scrollbar to allow vertical scrolling."""
    ...
    def build_ui(self):
        ...
        # --- 3. Console Output ---
        console_frame = ttk.Labelframe(self.main_frame, text="Fortran Engine Output", padding=10)
        console_frame.pack(fill="both", expand=True, padx=10, pady=5)
        
        self.console = tk.Text(console_frame, height=15, bg="grey", fg="lime", font=("Consolas", 12))
